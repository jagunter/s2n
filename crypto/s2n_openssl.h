...
#if !defined(OPENSSL_IS_AWS_LC) && !defined(OPENSSL_IS_BORINGSSL) && (S2N_OPENSSL_VERSION_AT_LEAST(1, 1, 0))
...
#if !defined(OPENSSL_IS_AWS_LC) && !defined(OPENSSL_IS_BORINGSSL) && !defined(OPENSSL_FIPS) && !defined(LIBRESSL_VERSION_NUMBER)
